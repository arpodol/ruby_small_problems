# Bug issue: Numbers aren't matching up
...
# The issue was something I had previously spent alot of time solving, integer division as opposed to float division.
# Thus for some cases, the division that Math.log was called on would not resolve correctly.
